package com.ldlywt.androidadvancedemo.view;
...
public class QQHealthView extends View {
    ...
    private void init() {
        ...
        mRatio = 450.f / 525.f;
        //初始化一些默认的参数
        mBackgroundCorner = SizeUtils.dp2px(5);
...
//        stepAnimator.start();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.avastar);
