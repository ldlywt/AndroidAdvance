package com.ldlywt.base.widget;
...
//            textView.setEllipsize(TextUtils.TruncateAt.END);
    ...
    public CommonTextView setWidthAndHeight(int w, int h) {
        setLayoutParams(new LinearLayout.LayoutParams(w, h));
        return this;
    }

    public CommonTextView setBackColor(@ColorRes int color) {
     ...
     * @return return
     */
    public CommonTextView setLeftTextColor(@ColorRes int color) {
        if (leftTextView == null) {
            initLeftText();
        }
        leftTextView.setTextColor(ContextCompat.getColor(mContext, color));
        return this;
    }
     ...
     * @return 返回
     */
    public CommonTextView setCenterTextColor(@ColorRes int color) {
        if (centerTextView == null) {
            initCenterText();
        }
        centerTextView.setTextColor(ContextCompat.getColor(mContext, color));
        return this;
    }
     ...
     * @return 返回
     */
    public CommonTextView setRightTextColor(@ColorRes int color) {
        if (rightTextView == null) {
            initRightText();
        }
        rightTextView.setTextColor(ContextCompat.getColor(mContext, color));
        return this;
    }
    ...
    public CommonTextView setLeftDrawableLeft(Drawable drawableLeft) {
        ...
        leftTextView.setCompoundDrawablePadding(0);
        return this;
    }
